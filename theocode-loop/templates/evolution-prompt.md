...
- **theo-code directory:** {{THEO_CODE_DIR}}
- **Plugin root:** {{PLUGIN_ROOT}}
- **Output directory:** {{OUTPUT_DIR}}
- **Baseline hygiene score:** {{BASELINE_SCORE}} (L1={{BASELINE_L1}}, L2={{BASELINE_L2}})
...
Research SOTA patterns from reference repos in `{{THEO_CODE_DIR}}/referencias/`.

**Steps:**
1. Read `{{PLUGIN_ROOT}}/templates/reference-catalog.md` to identify relevant repos for the prompt
...
4. Write findings to `{{THEO_CODE_DIR}}/.theo/evolution_research.md`
5. Define SOTA criteria in `{{THEO_CODE_DIR}}/.theo/evolution_criteria.md`
...
**Steps:**
1. Run evaluation: `bash {{PLUGIN_ROOT}}/scripts/theo-evaluate.sh {{THEO_CODE_DIR}}`
...
**Steps:**
1. Read `{{PLUGIN_ROOT}}/templates/sota-rubric.md` for the 5-dimension rubric
...
4. Calculate average
5. Write assessment to `{{THEO_CODE_DIR}}/.theo/evolution_assessment.md`
